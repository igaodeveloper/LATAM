  ...
  passengers = [
    {
      ...
      departure: new Date(),
      arrival: new Date(new Date().getTime() + 5 * 60 * 60 * 1000),
      origin: "São Paulo",
    ...
    },
    {
      ...
      departure: new Date(new Date().getTime() + 24 * 60 * 60 * 1000),
      arrival: new Date(new Date().getTime() + 30 * 60 * 60 * 1000),
    ...
    },
    {
      ...
      departure: new Date(new Date().getTime() + 48 * 60 * 60 * 1000),
      arrival: new Date(new Date().getTime() + 52 * 60 * 60 * 1000),
      origin: "Curitiba",
